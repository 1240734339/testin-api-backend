...
public class FileServer {
    ...
    private static final Logger log = LoggerFactory.getLogger(org.apache.jmeter.services.FileServer.class);
    ...
    private static final org.apache.jmeter.services.FileServer server = new org.apache.jmeter.services.FileServer();
     ...
     */
    public static org.apache.jmeter.services.FileServer getFileServer() {
        return server;
    }
    ...
    public synchronized void closeCsv(String name) {
        try {
            ...
            LogUtil.info("在处理中的CSV数量：" + files.size());
        } catch (Exception e) {
            LogUtil.error("关闭CSV异常：" + name, e);
        }
    }
