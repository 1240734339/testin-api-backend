...
public class KeystoreConfig extends ConfigTestElement implements TestBean, TestStateListener {
    ...
    private static final Logger log = LoggerFactory.getLogger(org.apache.jmeter.config.KeystoreConfig.class);
    ...
    public void testStarted(String host) {
        ...
        // 加载认证文件
        String path = this.getPropertyAsString("TEST-KEYSTORE-FILE-PATH");
        String password = this.getPropertyAsString("TEST-KEYSTORE-FILE-PASSWORD");
        InputStream in = null;
        try {
