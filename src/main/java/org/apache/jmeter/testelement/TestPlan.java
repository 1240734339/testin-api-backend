...
import cn.testin.extranal.io.jmeter.CustomerClassLoader;
...
public class TestPlan extends AbstractTestElement implements Serializable, TestStateListener {
    ...
    private static final Logger log = LoggerFactory.getLogger(org.apache.jmeter.testelement.TestPlan.class);
     ...
     * {@link org.apache.jmeter.testelement.TestPlan#CLASSPATH_SEPARATOR}.
     *
    ...
    public void testEnded() {
        LogUtil.info("Test plan " + this.getName() + "test end");
    }
    ...
    public void testStarted() {
        LogUtil.info("测试计划开始执行：" + this.getName());
