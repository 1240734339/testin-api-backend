...
public abstract class SSLManager {
    private static final Logger log = LoggerFactory.getLogger(org.apache.jmeter.util.SSLManager.class);
    ...
    private static org.apache.jmeter.util.SSLManager manager;
    ...
    public static synchronized void reset() {
        org.apache.jmeter.util.SSLManager.manager = null;
    }
...
//            }
     ...
     *
     * @return the singleton {@link org.apache.jmeter.util.SSLManager}
     */
    public static synchronized org.apache.jmeter.util.SSLManager getInstance() {
        if (null == org.apache.jmeter.util.SSLManager.manager) {
            org.apache.jmeter.util.SSLManager.manager = new JsseSSLManager(null);
        }

        return org.apache.jmeter.util.SSLManager.manager;
    }
    ...
    public static boolean isSSLSupported() {
        return org.apache.jmeter.util.SSLManager.IS_SSL_SUPPORTED;
    }
