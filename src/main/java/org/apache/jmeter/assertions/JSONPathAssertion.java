...
public class JSONPathAssertion extends AbstractTestElement implements Serializable, Assertion, ThreadListener {
    private static final Logger log = LoggerFactory.getLogger(org.apache.jmeter.assertions.JSONPathAssertion.class);
    ...
    private static ThreadLocal<DecimalFormat> decimalFormatter =
            ThreadLocal.withInitial(org.apache.jmeter.assertions.JSONPathAssertion::createDecimalFormat);
