...
import cn.testin.extranal.io.utils.DocumentUtils;
...
public class XMLAssertion extends AbstractTestElement implements Serializable, Assertion, ThreadListener {
    private static final Logger log = LoggerFactory.getLogger(org.apache.jmeter.assertions.XMLAssertion.class);
    private static ThreadLocal<DecimalFormat> decimalFormatter = ThreadLocal.withInitial(org.apache.jmeter.assertions.XMLAssertion::createDecimalFormat);
