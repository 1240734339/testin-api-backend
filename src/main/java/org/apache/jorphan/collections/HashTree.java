 ...
 * @see SearchByClass
 */
public class HashTree implements Serializable, Map<Object, org.apache.jorphan.collections.HashTree>, Cloneable {
    ...
    protected final Map<Object, org.apache.jorphan.collections.HashTree> data;
     ...
     */
    protected HashTree(Map<Object, org.apache.jorphan.collections.HashTree> _map) {
        this(_map, null);
    }
    ...
    public HashTree(Object key) {
        this(new LinkedHashMap<Object, org.apache.jorphan.collections.HashTree>(), key);
    }
     ...
     */
    private HashTree(Map<Object, org.apache.jorphan.collections.HashTree> _map, Object key) {
        if(_map != null) {
            data = _map;
        } else {
        ...
        if(key != null) {
            data.put(key, new org.apache.jorphan.collections.HashTree());
        }
    }
     ...
     *
     * @see #add(org.apache.jorphan.collections.HashTree)
     * @see Map#putAll(Map)
     */
    @Override
    public void putAll(Map<?, ? extends org.apache.jorphan.collections.HashTree> map) {
        if (map instanceof org.apache.jorphan.collections.HashTree) {
            this.add((org.apache.jorphan.collections.HashTree) map);
        } else {
     ...
     */
    @Override
    public Set<Entry<Object, org.apache.jorphan.collections.HashTree>> entrySet() {
     ...
     */
    @Override
    public org.apache.jorphan.collections.HashTree put(Object key, org.apache.jorphan.collections.HashTree value) {
        org.apache.jorphan.collections.HashTree previous = data.get(key);
        add(key, value);
        return previous;
    }
     ...
     */
    @Override
    public Collection<org.apache.jorphan.collections.HashTree> values() {
        return data.values();
    }
     ...
     */
    public void add(Object key, org.apache.jorphan.collections.HashTree subTree) {
        add(key).add(subTree);
    }
     ...
     */
    public void add(org.apache.jorphan.collections.HashTree newTree) {
    ...
    public HashTree(Collection<?> keys) {
        data = new LinkedHashMap<>();
        for (Object o : keys) {
            data.put(o, new org.apache.jorphan.collections.HashTree());
        }
    }
     ...
     */
    public void set(Object key, org.apache.jorphan.collections.HashTree t) {
        data.put(key, t);
    }
    ...
    public void set(Collection<?> treePath, Object[] values) {
        org.apache.jorphan.collections.HashTree tree = addTreePath(treePath);
     ...
     */
    public org.apache.jorphan.collections.HashTree add(Object key) {
        if (!data.containsKey(key)) {
            org.apache.jorphan.collections.HashTree newTree = createNewTree();
     ...
     */
    public org.apache.jorphan.collections.HashTree add(Object key, Object value) {
    ...
    public org.apache.jorphan.collections.HashTree add(Object[] treePath, Object value) {
     ...
     * @return HashTree for which <code>value</code> is the key
     */
    public org.apache.jorphan.collections.HashTree add(Collection<?> treePath, Object value) {
        org.apache.jorphan.collections.HashTree tree = addTreePath(treePath);
    ...
    protected org.apache.jorphan.collections.HashTree addTreePath(Collection<?> treePath) {
        org.apache.jorphan.collections.HashTree tree = this;
     ...
     */
    public org.apache.jorphan.collections.HashTree getTree(Object key) {
        return data.get(key);
    }
     ...
     */
    @Override
    public org.apache.jorphan.collections.HashTree get(Object key) {
        return getTree(key);
    }
     ...
     */
    public org.apache.jorphan.collections.HashTree getTree(Object[] treePath) {
        if (treePath != null) {
    ...
    @Override
    public Object clone() {
        org.apache.jorphan.collections.HashTree newTree = new org.apache.jorphan.collections.HashTree();
        cloneTree(newTree);
        return newTree;
    }

    protected void cloneTree(org.apache.jorphan.collections.HashTree newTree) {
        for (Object key : list()) {
            newTree.set(key, (org.apache.jorphan.collections.HashTree) getTree(key).clone());
        }
    }
     ...
     * @return HashTree
     */
    protected org.apache.jorphan.collections.HashTree createNewTree() {
        return new org.apache.jorphan.collections.HashTree();
    }
     ...
     *
     * @return newly created {@link org.apache.jorphan.collections.HashTree}
     */
    protected org.apache.jorphan.collections.HashTree createNewTree(Object key) {
        return new org.apache.jorphan.collections.HashTree(key);
    }
     ...
     * of HashTree.
     *
     * @param values objects to be added to the new {@link org.apache.jorphan.collections.HashTree}
     *
     * @return newly created {@link org.apache.jorphan.collections.HashTree}
     */
    protected org.apache.jorphan.collections.HashTree createNewTree(Collection<?> values) {
        return new org.apache.jorphan.collections.HashTree(values);
    }
     ...
     * @return HashTree at the end of the recursion
     */
    public org.apache.jorphan.collections.HashTree getTree(Collection<?> treePath) {
    ...
    public Collection<?> list(Object key) {
        org.apache.jorphan.collections.HashTree temp = data.get(key);
        if (temp != null) {
            return temp.list();
        }
        return new HashSet<>();
     ...
     */
    @Override
    public org.apache.jorphan.collections.HashTree remove(Object key) {
    ...
    public Collection<?> list(Collection<?> treePath) {
        org.apache.jorphan.collections.HashTree tree = getTreePath(treePath);
        if (tree != null) {
            return tree.list();
        }
        return new HashSet<>();
    ...
    public void replaceKey(Object currentKey, Object newKey) {
        org.apache.jorphan.collections.HashTree tree = getTree(currentKey);
    ...
    public Object[] getArray(Object key) {
        org.apache.jorphan.collections.HashTree t = getTree(key);
        if (t != null) {
            return t.getArray();
        }
        return null;
    ...
    protected org.apache.jorphan.collections.HashTree getTreePath(Collection<?> treePath) {
        org.apache.jorphan.collections.HashTree tree = this;
    ...
    public boolean equals(Object o) {
        if (!(o instanceof org.apache.jorphan.collections.HashTree)) {
            return false;
        }
        org.apache.jorphan.collections.HashTree oo = (org.apache.jorphan.collections.HashTree) o;
     ...
     */
    public org.apache.jorphan.collections.HashTree search(Object key) {
        org.apache.jorphan.collections.HashTree result = getTree(key);
        if (result != null) {
            return result;
        }
    ...
    private void traverseInto(HashTreeTraverser visitor) {
        if (list().isEmpty()) {
            ...
            for (Object item : list()) {
                final org.apache.jorphan.collections.HashTree treeItem = getTree(item);
    ...
    private static class TreeSearcher implements HashTreeTraverser {
        ...
        private org.apache.jorphan.collections.HashTree result;

        public TreeSearcher(Object t) {
            target = t;
        }

        public org.apache.jorphan.collections.HashTree getResult() {
            return result;
        }

        /** {@inheritDoc} */
        @Override
        public void addNode(Object node, org.apache.jorphan.collections.HashTree subTree) {
    ...
    private static class ConvertToString implements HashTreeTraverser {
        ...
        @Override
        public void addNode(Object key, org.apache.jorphan.collections.HashTree subTree) {
            depth++;
