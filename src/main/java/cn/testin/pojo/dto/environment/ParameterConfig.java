...
public class ParameterConfig{
     ...
     * 缓存同一批请求的认证信息
     */
    private Map<String, TestinKeyStore> keyStoreMap = new HashMap<>();
    /**
     * 公共场景参数
     */
...
//    public HttpConfig matchConfig(TestinHTTPSamplerProxy samplerProxy) {
...
//    }
    ...
    private String getParentProjectId(TestinHTTPSamplerProxy samplerProxy) {
        TestinElement parent = samplerProxy.getParent();
        while (parent != null) {
    ...
    public void compatible(TestinHTTPSamplerProxy samplerProxy) {
