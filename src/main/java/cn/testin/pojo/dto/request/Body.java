...
import cn.testin.commons.constants.StorageConstants;
import cn.testin.commons.utils.FileUtils;
import cn.testin.commons.utils.LogUtil;
import cn.testin.pojo.dto.request.json.JSONSchemaRunTest;
        ...
        if (StringUtils.isNotBlank(this.type) && StringUtils.equals(this.type, "JSON")) {
            if (StringUtils.isNotEmpty(this.format) && this.getJsonSchema() != null
                ...
                try {
                    ...
                    LogUtil.error("json mock value is abnormal", e);
                }
            }
        }
    }
