package cn.testin.pojo.dto.request.json;

import cn.testin.commons.utils.EnumPropertyUtil;
...
public class JSONSchemaRunTest {
    ...
    private static void analyzeObject(JsonObject object, JSONObject rootObj, Map<String, String> map) {
        if (object.has(BasicConstant.ALL_OF)) {
            ...
            analyzeProperty(rootObj, BasicConstant.TEST_OBJECT, object, map);
    ...
    private static String formerJson(String jsonSchema, Map<String, String> map) {
        ...
        if (root.get(BasicConstant.TEST_OBJECT) != null) {
            return gson.toJson(root.get(BasicConstant.TEST_OBJECT));
        }
