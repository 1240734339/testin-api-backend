...
/**
 * @author WangG
 * @title: TestinAuthManager
 * @description:
 */
@Data
@EqualsAndHashCode(callSuper = true)
@JSONType(typeName = "AuthManager")
public class TestinAuthManager extends TestinElement{

    private String type = "AuthManager";
    private String clazzName = TestinAuthManager.class.getCanonicalName();
    ...
    public static final Map<String, AuthManager.Mechanism> mechanismMap = new HashMap<String, AuthManager.Mechanism>() {{
    ...
    public void setAuth(HashTree tree, TestinAuthManager msAuthManager, HTTPSamplerProxy samplerProxy) {
        try {
            AuthManager authManager = initBase();
            Authorization auth = new Authorization();
            auth.setURL("");
