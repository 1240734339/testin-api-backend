...
/**
 * @author WangG
 * @title: TestinJDBCPostProcessor
 * @description:
 */
@Data
@EqualsAndHashCode(callSuper = true)
@JSONType(typeName = "JDBCPostProcessor")
public class TestinJDBCPostProcessor extends TestinElement {

    // type 必须放最前面，以便能够转换正确的类
    private String type = "JDBCPostProcessor";
    private String clazzName = TestinJDBCPostProcessor.class.getCanonicalName();
...
//            TestinJDBCPostProcessor proxy = null;
